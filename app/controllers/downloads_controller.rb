...
before_filter :authorise
  ...
  def new
	...
	@download = @album.downloads.new params[:download]
	@download.customer_id = @current_customer.id
	@download.save
  ...
  def create
    ...
    respond_to do |format|
      if @download.save
        format.html { redirect_to @download, notice: 'You have succesfully downloaded this album. Thank you for shopping with us.' }
